...
public class ReportOrderFilterByDateAdapter extends ArrayAdapter<OrderFilterByDate> {
    private Context context;
    private int resource;

    public ReportOrderFilterByDateAdapter(@NonNull Context context, int pResource, @NonNull ArrayList<OrderFilterByDate> pObjects) {
