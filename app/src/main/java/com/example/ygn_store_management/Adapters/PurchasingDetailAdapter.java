...
public class PurchasingDetailAdapter  extends ArrayAdapter<Product> {
    private Context context;
    private int resource;
    public PurchasingDetailAdapter(@NonNull Context context, int pResource, @NonNull ArrayList<Product> pObjects) {
